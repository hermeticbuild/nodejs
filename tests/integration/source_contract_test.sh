...
grep -F '# Do not edit. Generated by the configure script.' "$release_config"
grep -F '"node_module_version": 147' "$release_config"
grep -F '"node_use_ffi": "true"' "$release_config"
grep -F '"node_use_lief": "true"' "$release_config"
