...
crate, `temporal_capi`, and `temporal_rs`. `@nodejs_crates` uses `rules_rs`
0.0.86 to generate Rust targets from the Cargo lockfile. Rust targets use the
pinned Rust 1.92.0 toolchain for Linux x86_64, Linux arm64, macOS x86_64,
